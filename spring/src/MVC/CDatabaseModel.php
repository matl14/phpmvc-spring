...
class CDatabaseModel implements \Anax\DI\IInjectionAware
{
	...
	/**
	 * -----------------------------------------------------------------
	 * Below are methods used to create and execute sql queries,
	 * This is merely an extension to use $this->db in class
	 * -----------------------------------------------------------------
	 */
	...
	/**
	 * Build orderby part of query string
	 *
	...
	/**
	 * Build groupby part of query string
	 *
	...
	/**
	 * Build limit part of the string
	 *
	 * @param integer $condition for the limit part of the query
	 *
	 * @return $this
	 *
	 */
